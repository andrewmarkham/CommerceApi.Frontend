import { CommerceAddress, Country } from "@jhoose-commerce/core";
import { StripeAddressElementOptions } from "@stripe/stripe-js";


export function toTwoDigitCountryCode(code: string): string {
    const countryCodes: { [key: string]: string } = {
        ...
        "COL": "CO", "COM": "KM", "COG": "CG", "COD": "CD", "COK": "CK", "CRI": "CR", "HRV": "HR", "CUB": "CU",
...
export function toThreeDigitCountryCode(code: string): string {
    const countryCodes: { [key: string]: string } = {
        ...
        "CO": "COL", "KM": "COM", "CG": "COG", "CD": "COD", "CK": "COK", "CR": "CRI", "HR": "HRV", "CU": "CUB",
...
export function validateEmailAddress(email: string | undefined): boolean {
...
export function buildStripeAddressOptions(mode: "shipping" | "billing", countries: Array<Country>,address?: CommerceAddress, fallbackCountry?: string): StripeAddressElementOptions {
    
    const addressOptions: StripeAddressElementOptions = {
        "mode": mode,
        "autocomplete": {"mode" : "automatic"},
        allowedCountries: [...countries.map(c => toTwoDigitCountryCode(c.code))],
        blockPoBox: true,
        fields: {
            "phone": "always",
        },
        ...
        defaultValues: {
            ...
            address: {
                ...
                country: toTwoDigitCountryCode(address?.address.country.code ?? fallbackCountry ?? "us")
            },
            phone: address?.phone
        }
    };
